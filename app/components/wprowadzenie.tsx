    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-20">
        ...
        >
          ...
          <div className="absolute -top-2 -left-2 w-12 h-12 border-t border-l border-blue-500 z-0"></div>
          <div className="absolute -bottom-2 -right-2 w-12 h-12 border-b border-r border-blue-500 z-0"></div>
        </motion.div>
        ...
        >
          <div className="inline-block border border-blue-500/50 px-3 py-0.5 rounded-full">
          ...
          <h2 className="text-2xl md:text-6xl font-black uppercase tracking-tighter leading-tight text-white">
            Pasja wykuta <br /> 
            <span className="text-blue-500">nad brzegiem rzeki</span>
          </h2>
